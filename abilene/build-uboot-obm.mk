...
BOOT_OUT_TRUSTED_DIR:=$(BOOT_OUT_DIR)/trusted
BOOT_OUT_NONTRUSTED_DIR:=$(BOOT_OUT_DIR)/nontrusted
...
build_uboot_obm_$(1):
	...
	$$(hide)cp $$(SRC_DIR)/$$(BOOT_OUT_NONTRUSTED_DIR)/u-boot.bin $$(OUTPUT_DIR)/$(1)/nontrusted
	$$(hide)cp $$(SRC_DIR)/$$(BOOT_OUT_NONTRUSTED_DIR)/Wtm_rel_mmp3.bin $$(OUTPUT_DIR)/$(1)/nontrusted
	$$(hide)cp -rf $$(SRC_DIR)/$$(BOOT_OUT_NONTRUSTED_DIR)/ntim/ $$(OUTPUT_DIR)/$(1)/nontrusted/
	$$(hide)cd $$(OUTPUT_DIR)/$(1)/nontrusted/ && tar zcvf ntim.bin.tgz ntim
	$$(hide)cp $$(SRC_DIR)/$$(BOOT_OUT_TRUSTED_DIR)/u-boot.bin $$(OUTPUT_DIR)/$(1)/trusted
	$$(hide)cp $$(SRC_DIR)/$$(BOOT_OUT_TRUSTED_DIR)/Wtm_rel_mmp3.bin $$(OUTPUT_DIR)/$(1)/trusted
	$$(hide)cp $$(SRC_DIR)/$$(BOOT_OUT_TRUSTED_DIR)/coremorphall.bin $$(OUTPUT_DIR)/$(1)/trusted
	$$(hide)cp -rf $$(SRC_DIR)/$$(BOOT_OUT_TRUSTED_DIR)/ntim/ $$(OUTPUT_DIR)/$(1)/trusted/
