...
PUBLISHING_FILES+=src/droid_all_src.tgz:o:md5
PUBLISHING_FILES+=src/android_src.tgz:m:md5
PUBLISHING_FILES+=src/android_patches.tgz:m:md5
PUBLISHING_FILES+=src/kernel_src.tgz:m:md5
PUBLISHING_FILES+=src/kernel_patches.tgz:m:md5
PUBLISHING_FILES+=src/uboot_src.tgz:m:md5
PUBLISHING_FILES+=src/uboot_patches.tgz:m:md5
PUBLISHING_FILES+=src/obm_src.tgz:m:md5
PUBLISHING_FILES+=src/marvell_manifest.xml:m
PUBLISHING_FILES+=src/setup_android.sh:m
