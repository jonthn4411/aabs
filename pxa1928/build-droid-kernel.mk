...
build_droid_root_$$(product): output_dir
	...
	$$(hide)if [ -f $$(SRC_DIR)/out/target/product/$$(private_device)/system/build.prop ]; then cp $$(SRC_DIR)/out/target/product/$$(private_device)/system/build.prop $$(OUTPUT_DIR)/$$(private_product)/; fi
