...
build_droid_$$(product): 
	...
	$(hide)if [ "$$(private_device)" = "pxa1928ff" ]; then \
	$(hide)if [ -e $(SRC_DIR)/$(DROID_OUT)/$$(private_device)/Software_Downloader.zip ]; then cp -p -r $(SRC_DIR)/$(DROID_OUT)/$$(private_device)/Software_Downloader.zip $(OUTPUT_DIR)/Software_Downloader_pxa1928.zip; fi; fi
