...
PUBLISHING_FILES2+=$$(product)/tim_recovery_ulc2.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES2+=$$(product)/tim_ulc2.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES2+=$$(product)/ULC2_TLoader_eMMC_DDR.bin:./$$(product)/flash/:o:md5
