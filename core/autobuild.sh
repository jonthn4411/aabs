...
if [ "$FLAG_TEMP" = "true" ]; then
	...
	PUBLISH_DIR_BASE=${PUBLISH_DIR_BASE}/${ABS_BOARD}
	PUBLISH_DIR_BASE_BAK=$OFFICIAL_PUBLISH_DIR_BASE_BAK
	PUBLISH_DIR_BASE_BAK=${PUBLISH_DIR_BASE_BAK}/${ABS_BOARD}
	mkdir -p ${PUBLISH_DIR_BASE}
	mkdir -p ${PUBLISH_DIR_BASE_BAK}
fi
...
if [ "$FLAG_PUBLISH" = "true" ]; then
	...
	cp -a ${PUBLISH_DIR} ${PUBLISH_DIR_BASE_BAK}
