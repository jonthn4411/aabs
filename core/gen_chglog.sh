...
LAST_BUILD_FILE=LAST_BUILD.${RELEASE_FULL_NAME}
LAST_REL_FILE=LAST_REL.${RELEASE_FULL_NAME}
LAST_MS1_FILE=LAST_MS1.${RELEASE_FULL_NAME}
LAST_MS2_FILE=LAST_MS2.${RELEASE_FULL_NAME}
