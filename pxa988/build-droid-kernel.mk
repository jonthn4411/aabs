...
build_droid_$$(product): build_kernel_$$(product)
	...
	$(hide)if [ -e $(SRC_DIR)/flashing/factory/$$(private_device).img ]; then \
	cp -p -r $(SRC_DIR)/flashing/factory/$$(private_device).img $(OUTPUT_DIR)/$$(private_product)/factory.bin; fi
	$(log) "  done"
