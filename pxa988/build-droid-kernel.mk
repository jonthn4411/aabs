...
build_droid_$$(product): 
	...
	$(hide)if [ -e $(SRC_DIR)/$(DROID_OUT)/$$(private_device)/cache.img ]; then cp -p -r $(SRC_DIR)/$(DROID_OUT)/$$(private_device)/cache.img $(OUTPUT_DIR)/$$(private_product)/; fi
...
PUBLISHING_FILES+=$$(product)/cache.img:./$$(product)/flash/:o:md5
