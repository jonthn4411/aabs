...
PUBLISHING_FILES+=$$(product)/uImage:./$$(product)/flash/:m:md5
...
PUBLISHING_FILES+=$$(product)/WTM.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HLN2_NonTLoader_eMMC_DDR.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/obm.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/obm_auto.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/obm_trusted_tz.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/obm_trusted_ntz.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/u-boot.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/boot.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/recovery.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/uImage:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/zImage:./$$(product)/flash/:o:md5
PUBLISHING_FILES2+=$$(product)/vmlinux:./$$(product)/debug/:o:md5
PUBLISHING_FILES2+=$$(product)/System.map:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/primary_gpt_4g:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/secondary_gpt_4g:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/primary_gpt:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/secondary_gpt:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/userdata.img:./$$(product)/flash/:m:md5
PUBLISHING_FILES+=$$(product)/userdata_4g.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/userdata_8g.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/primary_gpt_8g:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/secondary_gpt_8g:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/system.img:./$$(product)/flash/:m:md5
PUBLISHING_FILES+=$$(product)/ramdisk.img:./$$(product)/debug/:m:md5
PUBLISHING_FILES+=$$(product)/ramdisk-rooted.img:./$$(product)/debug/:o:md5
PUBLISHING_FILES2+=$$(product)/symbols_system.tgz:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/ramdisk-recovery.img:./$$(product)/debug/:o:md5
...
##!!## blf files
PUBLISHING_FILES+=$$(product)/blf:./$$(product)/flash/:o:md5

##!!## security image
PUBLISHING_FILES+=$$(product)/tee_tw.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/teesst.img:./$$(product)/flash/:o:md5

PUBLISHING_FILES+=$$(product)/radio.img:./$$(product)/flash/:o:md5

PUBLISHING_FILES+=$$(product)/nvm-wb.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/nvm-td.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/nvm.img:./$$(product)/flash/:o:md5

PUBLISHING_FILES+=$$(product)/HL_CP.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/EM_CP.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/EM_CP_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/EM_CP_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/EM_M08_AI_Z1_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_M08_AI_Z1_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/KL_CP.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/KL_CP_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/KL_CP_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/KUNLUN_Z0_M14_AI_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/KUNLUN_A0_M15_AI_Flash.bin:./$$(product)/flash/:o:md5

PUBLISHING_FILES+=$$(product)/KUNLUN_Arbel.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/KUNLUN_Arbel_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/KUNLUN_Arbel_NVM.mdb:./$$(product)/debug/:o:md5

PUBLISHING_FILES+=$$(product)/HL_TD_CP.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_TD_CP_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_TD_CP_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_TD_M08_AI_A0_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/radio-helan-td.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HELAN_A0_M16_AI_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_WB_CP.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_WB_CP_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_WB_CP_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HLWT_TD_CP.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HLWT_TD_CP_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HLWT_TD_CP_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HLWT_TD_M08_AI_A0_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/nvm-helan-wb.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/nvm-helan-wt.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/radio-helan-wb.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/radio-helan-wt.img:./$$(product)/flash/:o:md5

PUBLISHING_FILES+=$$(product)/TABLET_CP.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/TABLET_MSA.bin:./$$(product)/flash/:o:md5

PUBLISHING_FILES+=$$(product)/radio-helanlte-ltg.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_DL_M09_Y0_AI_SKL_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_DL.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/nvm-helanlte-ltg.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_DL_M09_Y0_AI_SKL_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_DL_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_DL_DKB.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_DL_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LWG_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LWG_DKB.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LWG_M09_B0_SKL_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LWG_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/nvm-helanlte.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/Skylark_LTG.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/Skylark_LWG.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/radio-helanlte.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_SS_M09_Y0_AI_SKL_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_SL_DKB_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_SL_DKB.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/HL_LTG_SL_DKB_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/Skylark_LTG_V11.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/Skylark_LTG_V13.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/Skylark_LWG_V11.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/Skylark_LWG_V13.bin:./$$(product)/flash/:o:md5


PUBLISHING_FILES+=$$(product)/WK_CP_2CHIP_SPRW_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/WK_CP_2CHIP_SPRW_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/Boerne_DIAG.mdb.txt:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/ReliableData.bin:./$$(product)/flash/:o:md5
ifeq ($(product),pxa988dkb_def)
PUBLISHING_FILES+=$$(product)/Arbel_DIGRF3_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/Arbel_DIGRF3.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/Arbel_DIGRF3_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/Arbel_DKB_SKWS.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/Arbel_DKB_SKWS_NVM.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/Arbel_DKB_SKWS_DIAG.mdb:./$$(product)/debug/:o:md5
PUBLISHING_FILES+=$$(product)/TTD_M06_AI_A0_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/TTD_M06_AI_A1_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/TTD_M06_AI_Y0_Flash.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/WK_CP_2CHIP_SPRW.bin:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/WK_M08_AI_Y1_removelo_Y0_Flash.bin:./$$(product)/flash/:o:md5
endif
endef
...
PUBLISHING_FILES+=$$(product)/tools.img:./$$(product)/flash/:o:md5
PUBLISHING_FILES+=$$(product)/tools.tgz:./$$(product)/flash/:o:md5
