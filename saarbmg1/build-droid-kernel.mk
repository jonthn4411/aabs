...
package_droid_slc_$(1)_$(2):
	...
	cp -a $(SRC_DIR)/vendor/marvell/generic/telephony/prebuilt_bin.saarbmg2 $$(OUTPUT_DIR)/$(2)/ && \
	cd $$(OUTPUT_DIR)/$(2)/ && tar zcvf prebuilt_bin.gforce.tgz prebuilt_bin.gforce && tar zcvf prebuilt_bin.saarbmg1.tgz prebuilt_bin.saarbmg1 && tar zcvf prebuilt_bin.saarbmg2.tgz prebuilt_bin.saarbmg2
...
package_droid_mmc_$(1)_$(2):
	...
	$$(log) "  updating the modules..."
	$$(hide)if [ -d $$(OUTPUT_DIR)/$(2)/modules ]; then rm -fr $$(OUTPUT_DIR)/$(2)/modules; fi
	$$(hide)cd $$(OUTPUT_DIR)/$(2) && tar xzf modules_android_mmc.tgz && rsync -av --safe-links modules $$(OUTPUT_DIR)/$(2)/root_nfs/system/lib/
...
build_kernel_$$(os)_$$(storage)_$(2): output_dir $$(if $$(findstring root,$$(root)), cp_$$(os)_root_dir_$$(storage)_$(2) ) 
	...
	$$(hide)rsync -av --safe-links $$(SRC_DIR)/$$(KERNELSRC_TOPDIR)/out/modules/* $$(OUTPUT_DIR)/$(2)/modules
