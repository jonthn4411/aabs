...
3)       if burning is for PXA920H, you can choose the configuration file:
                TVTD_LPDDR2_Linux_eMMC.blf [For TD-EMMC]
        ...
        system.img                                      --> flash address 0x6800000 [Not For eMMC]
        system_ext4.img                                 --> flash address 0x6800000 [Only For eMMC]
        userdata.img                                    --> flash address 0x1080000 [Not For eMMC]
        userdata_ext4.img                               --> flash address 0x1080000 [Only For eMMC]
        pxafs.img                                       --> flash address 0x1ec0000 [Not For eMMC] 
        pxafs_ext4.img                                  --> flash address 0x1ec0000 [Only For eMMC]
...
so android UI and 3D applications will use SW version instead of GC500. To save 32MB from GC500 low level driver, you can run: "adb shell rm /system/lib/modules/galcore.ko"
